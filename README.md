...
* **Best Sampling Technique**: **Bootstrap Sampling (Sampling 5)** and **Stratified Sampling (Sampling 3)** proved to be the most effective, as they allowed both Random Forest and Decision Trees to achieve perfect or near-perfect accuracy scores.
* **Observation**: M3 (SVC) struggled the most compared to ensemble-based models like Random Forest and Decision Trees, particularly in the smaller random samples.
